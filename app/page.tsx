    ...
    <div className="fixed inset-x-0 top-0 bottom-0 w-full max-w-md md:max-w-3xl lg:max-w-4xl mx-auto bg-[#FAFAFA] pb-28 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none'] md:border-x md:border-gray-200 md:shadow-2xl">
          ...
          >
            ...
            <div className="flex items-center justify-between relative z-10">
              <div
                ...
                className="flex items-center gap-4 md:gap-5 cursor-pointer active:scale-95 transition-transform"
              >
                ...
                <div>
                  <p className="flex items-center text-xs md:text-sm font-bold text-gray-700 mb-0.5 drop-shadow-md">
                    ...
                    <GreetingIcon
                      size={16}
                      strokeWidth={2.5}
                      className={`${iconColor} ml-1.5 md:w-5 md:h-5`}
                    />
                  </p>
      ...
      <div className="px-6 md:px-10 mt-4 md:mt-6 space-y-4 md:space-y-6">
        <button
          ...
          className="w-full text-left focus:outline-none active:scale-[0.98] transition-transform block cursor-pointer"
        >
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
            <div className="bg-blue-100 py-3 md:py-4 px-4 md:px-5 rounded-2xl border border-gray-100 shadow-sm shadow-gray-100/50 flex items-center gap-3">
              ...
              <div className="flex flex-col ml-auto items-end">
                <p className="text-[14px] md:text-sm text-gray-500 font-medium mb-0.5">
                  ลากิจ
                </p>
            ...
            <div className="bg-orange-100 py-3 md:py-4 px-4 md:px-5 rounded-2xl border border-gray-100 shadow-sm shadow-gray-100/50 flex items-center gap-3">
              ...
              <div className="flex flex-col ml-auto items-end">
                ...
                <h4 className="text-[18px] md:text-xl font-bold text-gray-900 leading-none">
                  {leaveStats.annual}/{annualLeaveQuota}{" "}
                  <span className="text-[10px] md:text-xs font-normal text-gray-400">
                    วัน
                  </span>
                </h4>
            ...
            <div className="bg-pink-100 py-3 md:py-4 px-4 md:px-5 rounded-2xl border border-gray-100 shadow-sm shadow-gray-100/50 flex items-center gap-3">
              ...
              <div className="flex flex-col ml-auto items-end">
                <p className="text-[12px] md:text-sm text-gray-500 font-medium mb-0.5">
                  ลาป่วย
                </p>
                <h4 className="text-[18px] md:text-xl font-bold text-gray-900 leading-none">
                  {leaveStats.sick}{" "}
        ...
        <div className="bg-gray-100 p-3 md:p-5 rounded-[24px] md:rounded-[32px] mt-6 md:mt-8">
          <div className="grid grid-cols-2 gap-3 md:gap-5">
            <button
              ...
              className={`w-full text-left p-4 md:p-6 rounded-2xl md:rounded-[24px] border transition-all relative overflow-hidden ${
                !hasCheckedIn
                  ? "bg-blue-100 border-blue-200 shadow-md shadow-blue-100 cursor-pointer active:scale-95 hover:border-blue-300"
                  : "bg-white border-gray-100 shadow-sm cursor-default"
              }`}
            >
              {!hasCheckedIn && (
                <LogIn
                  size={150}
                  strokeWidth={1.5}
                  className="absolute -right-4 -bottom-8 text-blue-300/50 pointer-events-none md:w-[200px] md:h-[200px]"
                />
              )}
              <div className="relative z-10">
                <div
                  className={`w-10 h-10 md:w-12 md:h-12 rounded-xl md:rounded-2xl flex items-center justify-center mb-3 md:mb-4 ${!hasCheckedIn ? "bg-blue-600 text-white" : "bg-green-100 text-green-600"}`}
                >
                  <Clock
                    size={20}
                    strokeWidth={2.5}
                ...
                <p
                  className={`text-sm md:text-base font-medium mb-1 md:mb-2 ${!hasCheckedIn ? "text-blue-600" : "text-gray-500"}`}
                >
            ...
            <button
              onClick={() =>
                hasCheckedIn && !hasCheckedOut && router.push("/check-in")
              }
              ...
              className={`w-full text-left p-4 md:p-6 rounded-2xl md:rounded-[24px] border transition-all relative overflow-hidden ${
                !hasCheckedIn
                  ...
                  : hasCheckedIn && !hasCheckedOut
                    ? "bg-orange-100 border-orange-200 shadow-md shadow-orange-100 cursor-pointer active:scale-95 hover:border-orange-300"
                    : "bg-white border-gray-100 shadow-sm cursor-default"
              }`}
            >
              {hasCheckedIn && !hasCheckedOut && (
                <LogOut
                  size={150}
                  strokeWidth={1.5}
                  className="absolute -right-4 -bottom-8 text-orange-300/50 pointer-events-none md:w-[200px] md:h-[200px]"
                />
              )}
              <div className="relative z-10">
                <div
                  className={`w-10 h-10 md:w-12 md:h-12 rounded-xl md:rounded-2xl flex items-center justify-center mb-3 md:mb-4 ${!hasCheckedIn ? "bg-gray-200 text-gray-400" : hasCheckedIn && !hasCheckedOut ? "bg-orange-500 text-white" : "bg-orange-100 text-orange-600"}`}
                >
                  <LogOut
                    size={20}
                    strokeWidth={2.5}
                ...
                <p
                  className={`text-sm md:text-base font-medium mb-1 md:mb-2 ${!hasCheckedIn ? "text-gray-400" : hasCheckedIn && !hasCheckedOut ? "text-orange-600" : "text-gray-500"}`}
                >
                  {hasCheckedIn && !hasCheckedOut
                    ? "ลงเวลาออกงาน"
                    : "เวลาออกงาน"}
                ...
                <h4
                  className={`text-xl md:text-3xl font-bold ${!hasCheckedIn ? "text-gray-400" : "text-gray-900"}`}
                >
          ...
          <button
            ...
            className="w-full mt-4 md:mt-5 bg-white border border-gray-100 p-4 md:p-5 rounded-[20px] flex items-center justify-between shadow-sm active:scale-95 transition-all cursor-pointer hover:border-blue-200"
          >
          ...
          {activeTrip && (
            <div
              ...
              className="cursor-pointer mt-3 md:mt-4 w-full bg-red-50 border border-red-200 p-4 md:p-5 rounded-2xl flex items-center justify-between shadow-sm animate-pulse hover:bg-red-100 transition-all active:scale-[0.98]"
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs md:text-sm font-bold text-red-700 flex items-center gap-1.5">
                    <span className="w-2 h-2 rounded-full bg-red-500 animate-ping"></span>
                    กำลังบันทึกเดินทาง
                  </p>
                  <p className="text-[11px] md:text-xs text-gray-600 line-clamp-1 mt-0.5">
                    หัวข้อ: {activeTrip.purpose || "การเดินทางค้างไว้"}
                  </p>
                </div>
              </div>
              <div className="text-xs md:text-sm font-bold text-red-600 bg-white px-3 py-1.5 md:px-4 md:py-2 rounded-xl md:rounded-2xl border border-red-100 shadow-sm">
                จัดการต่อ &rarr;
              </div>
            </div>
          )}
        ...
        <div className="mt-6 md:mt-8 mb-4">
          <div className="flex items-center justify-between mb-4">
            <h3 className="flex items-center gap-1 font-bold text-md md:text-lg text-gray-900">
              <Megaphone
                size={16}
                className="text-blue-500 ml-2 md:w-5 md:h-5"
              />
              <span>ข่าวสาร</span>
            </h3>
            <button className="text-[11px] md:text-xs text-blue-600 font-bold bg-blue-50 px-3 md:px-4 py-1.5 md:py-2 rounded-full active:scale-95 transition-transform cursor-pointer hover:bg-blue-100">
              ดูทั้งหมด
            </button>
          </div>
          ...
          <div className="flex gap-4 overflow-x-auto pb-4 snap-x snap-mandatory [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
            <div className="snap-center shrink-0 w-[85%] md:w-[45%] h-36 md:h-44 relative rounded-[24px] overflow-hidden shadow-sm border border-gray-100 cursor-pointer active:scale-[0.98] transition-transform hover:shadow-md">
              ...
              <div className="absolute bottom-0 left-0 w-full p-4 md:p-5 flex flex-col justify-end">
                <span className="bg-blue-600/80 backdrop-blur-sm text-white text-[9px] md:text-[10px] font-bold px-2 py-0.5 rounded-md w-fit mb-1.5">
                  ประกาศวันหยุด
                </span>
                <h4 className="font-bold text-white text-sm md:text-base mb-0.5 line-clamp-1">
                  ประกาศวันหยุดสงกรานต์ ประจำปี 2569
                </h4>
                <p className="text-[11px] md:text-xs text-gray-300 line-clamp-1">
                  บริษัทขอประกาศแจ้งวันหยุดทำการในช่วงเทศกาลสงกรานต์...
                </p>
              </div>
            </div>
            ...
            <div className="snap-center shrink-0 w-[85%] md:w-[45%] h-36 md:h-44 relative rounded-[24px] overflow-hidden shadow-sm border border-gray-100 cursor-pointer active:scale-[0.98] transition-transform hover:shadow-md">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent"></div>
              <div className="absolute bottom-0 left-0 w-full p-4 md:p-5 flex flex-col justify-end">
                <span className="bg-orange-500/80 backdrop-blur-sm text-white text-[9px] md:text-[10px] font-bold px-2 py-0.5 rounded-md w-fit mb-1.5">
                  สวัสดิการ
                </span>
                <h4 className="font-bold text-white text-sm md:text-base mb-0.5 line-clamp-1">
                  อัปเดตสวัสดิการพนักงานใหม่
                </h4>
                <p className="text-[11px] md:text-xs text-gray-300 line-clamp-1">
                  เพิ่มโควตาวันลาพักร้อนและงบประมาณสำหรับการอบรม...
                </p>
              </div>
            </div>
          </div>
